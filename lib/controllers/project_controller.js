...
exports.deleteProject = exports.updateProject = exports.getProjectsById = exports.getProjects = exports.createProject = void 0;
const mongo_connect_1 = require("../db/mongo_connect");
const mongodb_1 = require("mongodb");
const createProject = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = req.body;
        const collection = yield (0, mongo_connect_1.dbConnection)('projects');
...
const getProjectsById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const collection = yield (0, mongo_connect_1.dbConnection)('projects');
        const document = yield collection.findOne({ _id: new mongodb_1.ObjectId(projectId) });
        return res.status(200).json(document);
    }
    catch (error) {
...
const updateProject = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const collection = yield (0, mongo_connect_1.dbConnection)('projects');
        const document = yield collection.updateOne(query, { $set: projectData });
        return res.status(200).json(document);
    }
    catch (error) {
...
const deleteProject = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const projectId = req.params.id;
        const collection = yield (0, mongo_connect_1.dbConnection)('projects');
        const document = yield collection.deleteOne({ _id: new mongodb_1.ObjectId(projectId) });
        return res.status(200).json(document);
    }
    catch (error) {
