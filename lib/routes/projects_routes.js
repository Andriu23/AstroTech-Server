...
projectRoutes.get('/projects/:id', project_controller_1.getProjectsById);
projectRoutes.put('/projects', project_controller_1.updateProject);
projectRoutes.delete('/projects/:id', project_controller_1.deleteProject);
